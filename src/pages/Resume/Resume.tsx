    ...
    return (
      <section className='resume' data-testid="resume" id='resume'>
        <aside className='resume__container'>
          ...
          <p className='resume__body'>My BA Hons in Communication Design from The Glasgow School of Art, allows me to develop digital products through research and design. After a decade working as a UX/UI Designer, I decided to move forward to the Tech world as a Frontend & FullStack Developer. <br /> 
